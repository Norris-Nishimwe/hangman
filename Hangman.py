...
class Hangman:
    ...
    def draw_hangman(self):
        if self.wrong_counter == 0:
            ...
            self.hangman_2()
        elif self.wrong_counter == 3:
            self.hangman_3()           
        elif self.wrong_counter == 4:
            self.hangman_4()
        elif self.wrong_counter == 5:
            self.hangman_5()    
        elif self.wrong_counter == 6:
            self.hangman_6()    
        elif self.wrong_counter == 7:
            self.hangman_7()
        elif self.wrong_counter == 8:
            self.hangman_8()
        elif self.wrong_counter == 9:
            self.hangman_9()
        elif self.wrong_counter == 10:
            self.hangman_10()            
        print()
